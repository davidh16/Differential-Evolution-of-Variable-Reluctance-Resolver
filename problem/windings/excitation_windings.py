...
def generate_excitation_windings(problem):
    ...
    x = ((problem.rs1 * math.cos(math.radians(problem.alS1 / 2)) + 1.5) - (problem.rs1 * math.cos(math.radians(problem.alS1 / 2)) + 0.3)) / 2

    # crtanje prvokutnika s desne strane pola
    femm.mi_drawrectangle(
        problem.rs1 * math.sin(math.radians(-problem.alS1 / 2)) - 1.5,
        problem.rs1 * math.cos(math.radians(-problem.alS1 / 2)) - 2,
        problem.rs1 * math.sin(math.radians(-problem.alS1 / 2)) - 0.3,
        problem.rs1 * math.cos(math.radians(-problem.alS1 / 2)) - 2 - problem.Sp / 2)
    ...
    femm.mi_addblocklabel(problem.rs1 * math.sin(math.radians(-problem.alS1 / 2)) - 1.5 + x,
                          problem.rs1 * math.cos(math.radians(-problem.alS1 / 2)) - 2 - problem.Sp/4)
    ...
    femm.mi_selectrectangle(
        ...
        problem.rs1 * math.cos(math.radians(-problem.alS1 / 2)) - 2 + 0.1,
        problem.rs1 * math.sin(math.radians(-problem.alS1 / 2)) - 0.2,
        problem.rs1 * math.cos(math.radians(-problem.alS1 / 2)) - 2 - problem.Sp / 2 - 0.1)
